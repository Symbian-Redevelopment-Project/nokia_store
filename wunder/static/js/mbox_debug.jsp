...
mboxDebugActionLog.prototype.show = function() {
  ...
  _window.put("<img sr" + "c='"
    + document.location.protocol + "//nokia.tt.omtrdc.net/ima" + "ges/log.gif"
...
mboxDebugActionProfile.prototype.show = function() {
  ...
  _window.put('<iframe width="100%" height="85%" src="http://nokia.tt.omtrdc.net/debug/x-profile.jsp?'
    + 'clientCode=nokia&mboxSession=' + _sessionId + '"></iframe><hr/>');
  _window.put('Client code: nokia<br/>');
